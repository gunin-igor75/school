...
public class FacultyControllerTest {
    ...
    public void getAllFacultyByColorOrNameTest() throws Exception {
        ...
        when(facultyRepository.findFacultyByColorIgnoreCaseOrNameIgnoreCase(name_1, name_1)).thenReturn(faculty_1);
        when(facultyRepository.findFacultyByColorIgnoreCaseOrNameIgnoreCase(color_2, color_2)).thenReturn(faculty_2);
